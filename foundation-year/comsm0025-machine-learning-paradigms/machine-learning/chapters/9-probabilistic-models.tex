...
\begin{dfn}
  [Likelihood ratio of a binary classifier]
...
\begin{proposition}
  [Likelihood ratio of a binary univariate GMM]
  \begin{align*}
    \lambda(x)
...
\begin{dfn}
  [Maximum-likelihood decision threshold of a binary classifier]
...
\begin{proposition}
  [Likelihood ratio of a binary multivariate GMM]
  \begin{align*}
    \lambda(\vec{x})
