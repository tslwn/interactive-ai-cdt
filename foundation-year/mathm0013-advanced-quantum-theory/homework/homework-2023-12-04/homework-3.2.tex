...
vertices; hence, the diagram in figure~\ref{fig:2b2} has multiplicity $2 \times
  15 = 30$.
In the diagram in figure~\ref{fig:2b3}, there are $\binom{6}{2}$ ways to choose
pairs of the $2$ $k$ and $6$ $\kpp$ vertices, $\binom{4}{2}$ ways to choose
pairs of the $2$ $\kp$ and remaining $4$ $\kpp$ vertices, and $2\doublefact$
ways to choose pairs of the remaining $2$ $\kpp$ vertices.
Hence, it has multiplicity $\binom{6}{2} \binom{4}{2} 2\doublefact = 180$.
...
\begin{figure}[ht!]
  ...
  \end{tikzpicture}
  \caption{\ref{2b}.
    Feynman diagram for $\avg{x_k^2 x_\kp^2 x_\kpp^6}$ of multiplicity $180$.
  }
  \label{fig:2b3}
\end{figure}
